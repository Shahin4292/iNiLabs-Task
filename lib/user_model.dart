...
enum EventsUrl {
  HTTPS_API_GITHUB_COM_USERS_SHAHIN4292_EVENTS_PRIVACY
}

final eventsUrlValues = EnumValues({
  "https://api.github.com/users/Shahin4292/events{/privacy}": EventsUrl.HTTPS_API_GITHUB_COM_USERS_SHAHIN4292_EVENTS_PRIVACY
});

enum FollowingUrl {
  HTTPS_API_GITHUB_COM_USERS_SHAHIN4292_FOLLOWING_OTHER_USER
}

final followingUrlValues = EnumValues({
  "https://api.github.com/users/Shahin4292/following{/other_user}": FollowingUrl.HTTPS_API_GITHUB_COM_USERS_SHAHIN4292_FOLLOWING_OTHER_USER
});

enum GistsUrl {
  HTTPS_API_GITHUB_COM_USERS_SHAHIN4292_GISTS_GIST_ID
}

final gistsUrlValues = EnumValues({
  "https://api.github.com/users/Shahin4292/gists{/gist_id}": GistsUrl.HTTPS_API_GITHUB_COM_USERS_SHAHIN4292_GISTS_GIST_ID
});
...
final nodeIdValues = EnumValues({
  "U_kgDOCHBeOw": NodeId.U_KG_DOCH_BE_OW
});

enum StarredUrl {
  HTTPS_API_GITHUB_COM_USERS_SHAHIN4292_STARRED_OWNER_REPO
}

final starredUrlValues = EnumValues({
  "https://api.github.com/users/Shahin4292/starred{/owner}{/repo}": StarredUrl.HTTPS_API_GITHUB_COM_USERS_SHAHIN4292_STARRED_OWNER_REPO
});
